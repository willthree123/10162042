...
void Q3() //Question 3
{
    ...
    while (Amount > result)
    {                                                                                //Run until saving up all the money
        result = result + day;                                                       //Calcuate Answer
        cout << "Day " << day << " you save $" << day << " so you have $" << result; // Display the result with proper format
        day++;
        if (Amount > result)
        {
            cout << endl;
...
void Q4() //Question 4
{
    ...
    for (int j = 0; j < size; j++)
    {
        ...
        tmpNum = firstNumber;
        for (int i = 0; i < tmpSize - 1; i++) //print space
        {
            cout << "  ";
        }
        for (int k = 0; k <= (size - tmpSize); k++) //print num and symbol
        {
            cout << tmpNum << symbol;
            tmpNum--;
        }
